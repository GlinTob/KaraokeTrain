...
export async function showTab(tabId) {
  ...
  try {
    if (normalizedTabId === "config") {
      ...
      const { initSettings, loadAvailableMics } = await import("./modules/config.js?v=5");
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  safeAdd("karaokeStopBtn", "click", async () => {
    const { stopKaraokeRecording } = await import("./modules/karaoke.js?v=5");
  ...
  safeAdd("refreshMicsBtn", "click", async () => {
    const { loadAvailableMics } = await import("./modules/config.js?v=5");
    if (typeof loadAvailableMics === "function") loadAvailableMics();
  });
  safeAdd("testMic1Btn", "click", async () => {
    const { testMicrophone } = await import("./modules/config.js?v=5");
  ...
  safeAdd("stopMic1TestBtn", "click", async () => {
    const { stopMicTest } = await import("./modules/config.js?v=5");
  ...
  try {
    const { initSettings, loadAvailableMics, toggleMic2Visibility } = await import("./modules/config.js?v=5");
    if (typeof initSettings === "function") initSettings();
    if (typeof loadAvailableMics === "function") await loadAvailableMics();
