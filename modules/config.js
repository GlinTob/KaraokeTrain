...
const AVATAR_CATEGORIES = {
  superheroes: {
    ...
    characters: [
      ...
      { id: "captain-america", name: "Captain America", img: "../assets/avatares/captain-america.png" },
      { id: "cyclops", name: "Cyclops", img: "../assets/avatares/cyclops.png" },
      { id: "deadpool", name: "Deadpool", img: "../assets/avatares/deadpool.png" },
      { id: "flash", name: "Flash", img: "../assets/avatares/flash.png" },
      { id: "gambit", name: "Gambit", img: "../assets/avatares/gambit.png" },
      { id: "hulk", name: "Hulk", img: "../assets/avatares/hulk.png" },
      { id: "iron-man", name: "Iron Man", img: "../assets/avatares/iron-man.png" },
      { id: "jean-grey", name: "Jean Grey", img: "../assets/avatares/jean-grey.png" },
      { id: "spider-man", name: "Spider Man", img: "../assets/avatares/spider-man.png" },
      { id: "storm", name: "Storm", img: "../assets/avatares/storm.png" },
      { id: "superman", name: "Superman", img: "../assets/avatares/superman.png" },
...
{ id: "human-torch", name: "Human Torch", img: "../assets/avatares/human-torch.png" },
  ...
  personajes: {
    ...
    color: "#AB8CFF",
    characters: [
      { id: "anonymous", name: "Anonymous", img: "../assets/avatares/anonymous.png" },
      { id: "baby-yoda", name: "Baby Yoda", img: "../assets/avatares/baby-yoda.png" },
      { id: "bart-simpson", name: "Bart", img: "../assets/avatares/bart.png" },
      { id: "brave", name: "Brave", img: "../assets/avatares/brave.png" },
      { id: "brutus", name: "Brutus", img: "../assets/avatares/brutus.png" },
      { id: "chucky", name: "Chucky", img: "../assets/avatares/chucky.png" },
      { id: "cookie-monster", name: "C Monster", img: "../assets/avatares/cookie-monster.png" },
      { id: "darth-vader", name: "Darth Vader", img: "../assets/avatares/darth-vader.png" },
      { id: "donald", name: "Donald", img: "../assets/avatares/donald.png" },
      { id: "finn", name: "Finn", img: "../assets/avatares/finn.png" },
      { id: "freddy", name: "Freddy", img: "../assets/avatares/freddy.png" },
      { id: "genie", name: "Genie", img: "../assets/avatares/genie.png" },
      { id: "groot", name: "Groot", img: "../assets/avatares/groot.png" },
      { id: "harry", name: "H.P", img: "../assets/avatares/harry.png" },
      ...
      { id: "mummy", name: "Mummy", img: "../assets/avatares/mummy.png" },
      { id: "navi", name: "Na'vi", img: "../assets/avatares/navi.png" },
      { id: "ninja-turtle", name: "Ninja Turtle", img: "../assets/avatares/ninja-turtle.png" },
